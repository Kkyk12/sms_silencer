...
class ScheduledMessagesScreen extends StatefulWidget {
  const ScheduledMessagesScreen({super.key, this.address, this.displayName});
...
class _ScheduledMessagesScreenState extends State<ScheduledMessagesScreen> {
  ...
  Future<void> _load() async {
    final msgs = await NativeBridge.getScheduledMessages(widget.address ?? '');
                ...
                return ListTile(
                  ...
                  onTap: _allMode
                      ? () => Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (_) => ThreadScreen(address: m.address),
                          ),
                        ).then((_) => _load())
                      : null,
